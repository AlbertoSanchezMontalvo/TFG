...
namespace OpenAI
{
    public class GPTController : MonoBehaviour
    {
        ...
        public async void SendReply(string text/*, string click*/)
        {
            Debug.Log("SENDREPLY");
